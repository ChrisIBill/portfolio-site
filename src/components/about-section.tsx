    ...
    <div className="flex flex-col min-h-fit w-fit full items-center justify-center transition-transform drop-shadow-glow">
      <div className="flex flex-col justify-center w-full">
        <AboutTextWrapper>
          ...
          building performant applications and expanding my knowledge of the
          field.
        </AboutTextWrapper>
        <AboutTextWrapper>
        ...
        <AboutTextWrapper>With extensive knowledge of</AboutTextWrapper>
        <AboutTextWrapper>
          C#, JavaScript, TypeScript, HTML, CSS, SQL, and Python.
        </AboutTextWrapper>
        <AboutTextWrapper>
          Currently seeking full-time opportunities in the field and working on
